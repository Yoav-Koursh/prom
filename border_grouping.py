...
def find_object_locations(img, expected_loc, R): #finds border with most pixels and returns its avg location
    ...
    while True:
        ...
        if non_empty_pixels.size == 0:
            ...
            if num_pixels > most_pixels and num_pixels > 10 :#and temp_object_location[0] < expected_loc[0] + R and temp_object_location[0] > expected_loc[0] - R and temp_object_location[1] < expected_loc[1] + R and temp_object_location[1] > expected_loc[1] - R :
